...
public class CommandBuilder {
    ...
    /**
     * Subcommand that does nothing, just used to test if an ICommand can support
     * removing subcommands.
     */
    private static final ICommand SAMPLE = new CommandBuilder( "_*^Sample-Command^*_" ).subCommand( true )
            .withAliases( new String[] { "hi" } ).onExecute( ( context ) -> {
                return true;
            } ).build();
    ...
    /**
     * Constructs a new builder with default values for all properties (that have
     * default values) and the given command name.
     * <p>
     * By default:
     * <ul>
     ...
     * {@link ICommand#onFailure(CommandContext, FailureReason) onFailure}
     * operations will be set to the same {@link Predicate}, {@link Consumer}, and
     * {@link BiConsumer} instances as the given builder.
     *
     * @param name
     *            The name of the command to be built.
     * @param cb
     *            The builder to copy property values from.
     * @throws NullPointerException
     *             if the name is null.
     * @throws IllegalArgumentException
     *             if the name is the empty string.
     * @see ICommand#getName()
     */
    public CommandBuilder( String name, CommandBuilder cb ) throws NullPointerException, IllegalArgumentException {
     ...
     * {@link ICommand#execute(com.github.thiagotgm.modular_commands.api.CommandContext)
     * execute},
     * {@link ICommand#onSuccess(com.github.thiagotgm.modular_commands.api.CommandContext)
     * onSuccess}, and
     * {@link ICommand#onFailure(com.github.thiagotgm.modular_commands.api.CommandContext, com.github.thiagotgm.modular_commands.api.FailureReason)
     * onFailure} operations will be set to just call the equivalent operations of
     * the given command.
     * <p>
     * If the given command supports modifying the subcommand set (tested by calling
     * {@link ICommand#removeSubCommand(ICommand)} with a sample subcommand and
     * checking if it threw an {@link UnsupportedOperationException}), the builder
     * is initially set to build a command that also allows modifying the subcommand
     * set. Else it is set to not allow it.
     *
     * @param name
     *            The name of the command to be built.
     * @param c
     *            The command to copy property values from.
     * @throws NullPointerException
     *             if the name is null.
     * @throws IllegalArgumentException
     *             if the name is the empty string.
     * @see ICommand#getName()
     */
    public CommandBuilder( String name, ICommand c ) throws NullPointerException, IllegalArgumentException {
     ...
     *
     * @param essential
     *            Whether the command is essential.
     * @return This builder.
     ...
     *             if the command being built is a subcommand.
     ...
     *
     * @param aliases
     *            The aliases for the built command.
     * @return This builder.
     * @throws NullPointerException
     *             if the given aliases collection is null.
     * @throws IllegalArgumentException
     *             if null or the empty string was included as an alias.
    ...
    /**
     * Convenience method for setting aliases through an array instead of a
     * Collection.
     *
     * @param aliases
     *            The aliases for the built command.
     * @return This builder.
     * @throws NullPointerException
     *             if the given aliases array is null.
     * @throws IllegalArgumentException
     *             if null or the empty string was included as an alias.
     * @see #withAliases(Collection)
     */
    public CommandBuilder withAliases( String[] aliases ) throws NullPointerException, IllegalArgumentException {
     ...
     *
     * @param subCommand
     *            Whether the command being built is a subcommand.
     * @return This builder.
     ...
     * @return This builder.
     * @throws NullPointerException
     *             If the description given is null.
     ...
     * <p>
     * <b>NOTE:</b> Rate-limited executions of the predicate are automatically
     * re-attempted as a whole. As such, it may not be safe to perform multiple
     * potentially rate-limited operations in the predicate, particularly on the
     * same endpoint.
     *
     * @param operation
    ...
    /**
     * Sets the time that should be waited between a successful execution of the
     * command and the call to the onSuccess operation.
     *
     * @param delay
     ...
     *            The time delay.
     * @param unit
     *            The unit that the delay is expressed in.
     * @return This builder.
     * @throws IllegalArgumentException
     *             if the value given is negative.
     * @see #withOnSuccessDelay(long)
     */
    public CommandBuilder withOnSuccessDelay( long delay, TimeUnit unit ) throws IllegalArgumentException {
    ...
    /**
     * Sets the operation that should be performed after a successful execution of
     * the command and after the onSuccess time delay.
     * <p>
     * <b>NOTE:</b> Rate-limited executions of the consumer are automatically
     * re-attempted as a whole. As such, it may not be safe to perform multiple
     * potentially rate-limited operations in the consumer, particularly on the same
     * endpoint.
     *
     * @param operation
     *            The operation to be performed.
    ...
    /**
     * Sets whether the command should always reply to the caller on a private
     * channel.
     *
     * @param replyPrivately
     *            Whether the command should always reply privately.
     * @return This builder.
     ...
     *
     * @param ignorePublic
     *            Whether the command should ignore public calls.
     * @return This builder.
     ...
     *
     * @param ignorePrivate
     *            Whether the command should ignore private calls.
     * @return This builder.
     ...
     *
     * @param ignoreBots
     *            Whether the command should ignore calls by bots.
     * @return This builder.
    ...
    /**
     * Sets whether the command should delete the message that called it after a
     * successful execution.
     *
     * @param deleteCommand
     *            Whether the calling message should be deleted.
     * @return This builder.
     ...
     *
     * @param requiresOwner
     *            Whether the command can only be called by the bot owner.
     * @return This builder.
     ...
     *
     * @param NSFW
     *            Whether the command can only be called on a NSFW-marked channel.
     * @return This builder.
     * @see ICommand#isNSFW()
     */
    ...
    /**
     * Sets whether the command can be overriden by a command in a subregistry of
     * the registry it is registered to.
     *
     * @param overrideable
     *            Whether the command can be overriden.
     * @return This builder.
     ...
     *
     * @param executeParent
     *            Whether the parent should be executed.
     * @return This builder.
    ...
    /**
     * Sets whether the command requires that the permission requirements for its
     * parent command be also satisfied in addition to its own.
     *
     * @param requiresParentPermissions
     *            Whether the parent's permissions are also required.
     * @return This builder.
    ...
    /**
     * Sets the (channel-overriden) permissions that a user must have on the channel
     * in order to call the command.
     *
     * @param permissions
     *            The required permissions.
     * @return This builder.
     * @throws NullPointerException
     *             if the permission set given is null.
     * @see ICommand#getRequiredPermissions()
     */
    public CommandBuilder withRequiredPermissions( EnumSet<Permissions> permissions ) throws NullPointerException {
     ...
     */
    public CommandBuilder withRequiredGuildPermissions( EnumSet<Permissions> permissions ) throws NullPointerException {
     ...
     *
     * @param subCommands
     *            The subcommands to be used.
     * @return This builder.
     * @throws NullPointerException
     *             if the given command collection is null.
     * @throws IllegalArgumentException
     *             if there are two or more subcommands with the same name.
    ...
    /**
     * Sets whether the command being built should allow modifying the subcommand
     * set after being built.
     *
     * @param canModify
     *            Whether the subcommand set can be modified after building.
     * @return This builder.
     * @see Command
     */
     ...
     * <p>
     * All properties that do not specify a default value must be specified one
     * before the command can be built.
     *
     * @return The built command.
     * @throws IllegalStateException
     *             If a value was not specified for a property that does not have a
     *             default value.
     */
    public Command build() throws IllegalStateException {
        ...
        return new Command( essential, prefix, name, aliases, subCommand, description, usage, commandOperation,
                onSuccessDelay, onSuccessOperation, onFailureOperation, replyPrivately, ignorePublic, ignorePrivate,
                ignoreBots, deleteCommand, requiresOwner, NSFW, overrideable, executeParent, requiresParentPermissions,
                requiredPermissions, requiredGuildPermissions, subCommands, canModifySubCommands, priority );
